			...
			return this.waitUntil(function () {
				return this.execute(function (selector, customLabels) {
					return (function () {
						...
						var traverseDomExactMatch = function (origin, target) {
							try {
								...
								if (results.length == 0) {
									...
									return traverseDomExactMatch(parent, target);
								}
						...
						var Strategies = {
							...
							searchTextExactMatch: function (container, text) {
								return traverseDomExactMatch(container, text)
							},
							searchTextContains: function (container, text) {
						...
						var findElement = function (container, label) {
							...
							e = Strategies.searchTextContains(container, l);
							if (e && e.length > 0) return e;
